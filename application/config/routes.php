...
$route['stock/edit/(:num)'] = 'stock/edit/$1';
$route['stock/delete/(:num)'] = 'stock/delete/$1';
...
$route['api_tokens/edit/(:num)'] = 'api_tokens/edit/$1';
$route['api_tokens/delete/(:num)'] = 'api_tokens/delete/$1';
